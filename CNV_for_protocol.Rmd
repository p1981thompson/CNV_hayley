...
Children who carry an extra X or Y chromosome do not have any gross physical or mental abnormalities however there is a pronounced increase in the risk of language impairment and autistic features (Bishop, Jacobs, et al 2011). The rationale for this project is that investigation of the genetic correlates of language and communication variations in children with sex chromosome trisomies (SCT) may lead to improved understanding of common neurodevelopmental disorders in children with a typical karyotype. 
...
In the current paper, we consider another way in which an extra sex chromosome could amplify genetic risk, by interacting with copy number variants (CNVs).  The history of recognition of CNVs is documented by Beckmann et al (2007): the earliest descriptions of deletions or insertions affecting chunks of DNA 1 kb in length or larger were made in the 1960s and 1970s, but it was a few decades later before it was recognised that this kind of large-scale submicroscopic variation is common and not necessarily pathological. However, where the CNVs are large and/or affect the function of key genes, they are associated with neurodevelopmental disorders, notably intellectual disability or autism spectrum disorder. One study also found an association with severe developmental language disorder (Kalnak et al, 2018).  

Large, disruptive CNVs tend to be relatively rare in populations. However, smaller CNVs are more common, and Simpson et al (2015) found that there was a slight increase in these in cases of developmental language disorder (DLD) and their relatives, compared to a control sample. The fact that unaffected relatives showed the increase as well as affected individuals suggested that an increased burden of CNVs may play a cumulative role in mediating an increased risk of language disorder, but the precise impact may depend on the location and extent of the CNV, and whether it disrupts gene function. The specific combination of inherited events may also be important. 

A CNV-based version of the double-hit hypothesis maintains that the risk of neurodevelopmental disorder associated with a CNV is increased when there is a trisomy, because of interactions between CNVs and the overexpression of genes on the sex chromosomes. This is the first hypothesis we plan to test, and may be regarded as a version of a two-hit model (Veltman & Brunner, 2010),  whereby the effect of a microdeletion is not deterministic, but rather it acts as a risk factor that can to increase the impact of  deletions or duplications elsewhere on the genome. This model was supported by the discovery by Girirajan et al (2010) that individuals with severe neurodevelopmental disorders who had a deletion at the 16p12.1 locus often had a second CNV.  A genomic alteration that may have little or no effect in an unaffected relative appeared to have a particularly detrimental effect in combination with a second 'hit'. 
...
The best source of evidence for an increased CNV burden comes from Rocca et al (2016), who presented evidence that men with Klinefelter syndrome (47,XXY) had an unusually high number of X-chromosome CNVs. They compared CNV burden on the X-chromosome in 94 men with Klinefelter (47, XXY) syndrome to that in 85 controls (43 males and 42 females), and reported a higher number of CNVs, especially duplications, in the Klinefelter group. Thirty-nine of them (41.5%) carried CNVs, compared to 12/42, (28.6%) of females, and 8/43, (18.6%) of males. As the authors noted, an increased CNV burden could provide an explanation for the variable phenotype, but they did not test for associations with phenotype in their sample. Their study raises the question of whether an increased rate of CNVs might be seen in other sex chromosome trisomies - XXX and XYY - and whether these might be found on the autosomes as well as the X-chromosome.
...
As shown in Figure 1, in model A, the comparison and SCT groups do not differ in CNV burden (x-axis), but they differ in the slope of the regression linking CNV burden to phenotype. In model B, the SCT group has a greater burden of CNVs, which is sufficient to account for the more severe phenotype in this group, without needing to postulate any difference between groups in the function linking CNV burden to phenotype. Both hypotheses are directional, and they are not mutually exclusive. 
...
ncases<-120 #number of cases each for sct and control (roughly correct, though more controls in practice)
...
Both the participant phenotyping and genome-wide SNP array data were generated for the companion study preregistered by Newbury et al (2018). 
...
Because we have directional predictions, we will use one-tailed statistical tests with alpha set to .05. As noted above, we will use permutation testing to adjust for multiple comparisons.
...
colnames(rtab) <- c('1.total_cnv','2.total_Kbp','3.sum_pLi')
...
summary(m1 <- glm(phenord ~ sum_pLi_C + Group, family="poisson", data=CNV_dat))
