...
The CNV analysis will test for the number of CNVs, total base pairs covered by CNVs (Mbp) and a sum of the predicted likelihood of intolerance scores for each of the SCT and comparison group individuals. Individual large and pathogenic CNVs will be identified separately as these may be of clinical significance.  
